...
// on window refresh
 if (performance.navigation.type == 1){
    ...
    var index = currentURL.indexOf("#Project-");
    if(index > -1) {
        bodyScroll()
        window.location.href = currentURL.substring(0, index + 8);
    } 
}
...
function topFunction() {
 ...
 $("#scroll_to_top").on('click', topFunction);
